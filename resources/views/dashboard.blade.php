...
@section('contenido')
    <div class="flex justify-center">
        <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col items-center md:flex-row">
            ...
            <div class="md:w-8/12 lg:w-6/12 px-5 flex md:flex-col items-center md:justify-center md:items-start py-10 md:py-10">
    ...
    <section class="container mx-auto mt-10">
        ...
        <x-listar-post :posts="$posts" :emptyMessage="'No hay posts'" />
