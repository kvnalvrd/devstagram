        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{ route('register') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input id="email" name="email" type="email" placeholder="Tu Correo Electrónico de Registro" class="border p-3 w-full rounded-lg @error('email')
                            border-red-500
